...
test("should create empty Series", () => {
...
test("should create Series from an array of values", () => {
  const data = new Float32Array([1, 2, 3]);
...
test("should iterate over the series index and value pairs", () => {
  const data = new Float32Array([1, 2, 3]);
  const index = new Float32Array([0, 1, 2]);
  const options = {
    name: "Series",
...
test("should iterate over the series values", () => {
  const data = new Float32Array([1, 2, 3]);
  const index = new Float32Array([0, 1, 2]);
  const options = {
    name: "Series",
...
test("should correctly set index values", () => {
  const data = new Float32Array([1, 2, 3]);
  const index = new Float32Array([0, 1, 2]);
  const options = {
    name: "Series",
...
test("should correctly get the value at a specific index", () => {
...
test("should correctly set the value at a nearest index", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
...
test("should correctly set the value at a specific index", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 3, 7, 11, 13]);
  const options = {
    name: "Series",
...
test("should correctly map the series", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly slice the series", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly filter the series", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly iterate over the series", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the minimum value", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the maximum value", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the mean value", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the sum of the series", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the std value", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the first value", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the last value", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly add two series", () => {
...
test("should correctly subtract two series", () => {
  const data1 = new Float32Array([1, 2, 3, 4, 5]);
  const data2 = new Float32Array([5, 4, 3, 2, 1]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
...
test("should correctly multiply two series", () => {
  const data1 = new Float32Array([1, 2, 3, 4, 5]);
  const data2 = new Float32Array([5, 4, 3, 2, 1]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
...
test("should correctly divide two series", () => {
  const data1 = new Float32Array([1, 2, 3, 4, 5]);
  const data2 = new Float32Array([5, 4, 3, 2, 1]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
...
test("should correctly add the series values", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
  ...
  expect(series.scalarAdd(2).values).toEqual(new Float32Array([3, 4, 5, 6, 7]));
});

test("should correctly subtract the series values", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly multiply the series values", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly divide the series values", () => {
...
test("should correctly check if every value in the series meets the condition", () => {
  const data = new Float32Array([2, 4, 6, 8, 10]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly check if some values in the series meet the condition", () => {
  const data = new Float32Array([2, 4, 6, 8, 10]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly get the cumulative sum of the series", () => {
  const data = new Float32Array([1, 2, 3, 4, 5]);
  const index = new Float32Array([0, 1, 2, 3, 4]);
  const options = {
    name: "Series",
...
test("should correctly calculate the difference of the series", () => {
