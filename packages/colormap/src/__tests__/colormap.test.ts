import { ColorMapSpec, createColormap } from "../colorMap";

describe("createColormap", () => {
  it("should create a colormap with default settings", () => {
    const colormap = createColormap();
    expect(colormap).toBeDefined();
    expect(Array.isArray(colormap)).toBe(true);
  });

  it("should create a colormap with specified nshades", () => {
    const spec: ColorMapSpec = { nshades: 10 };
    const colormap = createColormap(spec);
    expect(colormap.length).toBe(10);
  });

  it("should throw an error for unsupported colormap", () => {
  ...
  it("should create a colormap with hex format", () => {
  ...
  it("should create a colormap with rgbaString format", () => {
  ...
  it("should create a colormap with float format", () => {
