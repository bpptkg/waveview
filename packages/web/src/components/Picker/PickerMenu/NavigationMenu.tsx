...
const HelicorderNavigationMenuList = () => {
  const {
...
const SeismogramNavigationMenuList = () => {
  const {
...
const NavigationMenu = () => {
  ...
  return (
    <Menu>
      ...
      <MenuPopover>
        {selectedChart === 'helicorder' && <HelicorderNavigationMenuList />}
        {selectedChart === 'seismogram' && <SeismogramNavigationMenuList />}
      </MenuPopover>
    </Menu>
  );
};
